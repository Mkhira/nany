...
class nany_signup_view extends StatefulWidget {
  const nany_signup_view({Key, key}) : super(key: key);

  @override
  _nany_signup_viewState createState() => _nany_signup_viewState();
}

class _nany_signup_viewState extends State<nany_signup_view> {
  var obscure = true;
                              ...
                              onPressed: () {
                                if (formkey.currentState!.validate()) {
                                  ...
                                  nanyFirebaseAuthController()
                                      ...
                                      .then((value) {
                                    if (value == true) {
                                      nanyFirebaseAuthController().signInWithEmailAndPassword(email.text, password.text, context).then((value){
                                        SaveData();
                                        if (value == true) {
                                          setState(() {
  ...
  SaveData() async {
    nannyDataModel model = new nannyDataModel();
    ...
    FirebaseFirestore.instance
        .collection('nanny').doc(FirebaseAuth.instance.currentUser!.uid)
        .set(model.toJson())
        .then((value) => {
              AnimatedSnackBar(
                builder: ((context) {
