                                    ...
                                    children: [
                                      InkWell(
                                        onTap: () {
                                          ...
                                          Navigator.of(context)
                                              .pushReplacement(MaterialPageRoute(builder: (context) => parent_bottombar_view()));
                                        },
                                        child: Icon(
                                          Icons.arrow_back,
                                          size: 20,
                                      ...
                                      InkWell(
                                        onTap: () {
                                          ...
                                          scaffoldkey.currentState!.showBottomSheet((context) => parent_search_filter_view(),
                                                                    ...
                                                                    return InkWell(
                                                                      onTap: () {
                                                                        FirebaseFirestore.instance
                                                                            ...
                                                                            .update({
                                                                          'favourite':
                                                                              FieldValue.arrayUnion([snapshot.data!.elementAt(index).id])
                                                                        }).then((value) => {
                                                                                  setState(() {
                                                                                    print('added');
                                                                                    search_controller.parentModel.value.favourite!
                                                                                        .add(snapshot.data!.elementAt(index).id);
                                                                                  })
                                                                                });
                                                                      },
                                                                    ...
                                                                    return InkWell(
                                                                      onTap: () {
                                                                        FirebaseFirestore.instance
                                                                            ...
                                                                            .update({
                                                                          'favourite':
                                                                              FieldValue.arrayRemove([snapshot.data!.elementAt(index).id])
                                                                        }).then((value) => {
                                                                                  setState(() {
                                                                                    search_controller.parentModel.value.favourite!
                                                                                        .remove(snapshot.data!.elementAt(index).id);
                                                                                    print('removed');
                                                                                  })
                                                                                });
                                                                      },
