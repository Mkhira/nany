...
class _privacy_policy_viewState extends State<privacy_policy_view> {
  ...
  var selectedIndex = 0;
  List pages = [parent_search_view(), ParentSignupView(), ParentSignupView(), ParentSignupView()];
          ...
          BottomNavigationBarItem(
              icon: Container(
                ...
                child: Icon(
                  ...
                  color: selectedIndex == 0 ? Colors.white : Theme.of(context).primaryColor,
                ),
                decoration:
                    BoxDecoration(shape: BoxShape.circle, color: selectedIndex == 0 ? Theme.of(context).primaryColor : Colors.white10),
              ),
              label: 'search'),
          BottomNavigationBarItem(
              icon: Container(
                ...
                child: Icon(
                  ...
                  color: selectedIndex == 1 ? Colors.white : Theme.of(context).primaryColor,
                ),
                decoration:
                    BoxDecoration(shape: BoxShape.circle, color: selectedIndex == 1 ? Theme.of(context).primaryColor : Colors.white10),
              ),
              label: 'search'),
          BottomNavigationBarItem(
              icon: Container(
                ...
                child: Icon(
                  ...
                  color: selectedIndex == 2 ? Colors.white : Theme.of(context).primaryColor,
                ),
                decoration:
                    BoxDecoration(shape: BoxShape.circle, color: selectedIndex == 2 ? Theme.of(context).primaryColor : Colors.white10),
              ),
              label: 'search'),
          BottomNavigationBarItem(
              icon: Container(
                ...
                child: Icon(
                  Icons.person,
                  color: selectedIndex == 3 ? Colors.white : Theme.of(context).primaryColor,
                ),
                decoration:
                    BoxDecoration(shape: BoxShape.circle, color: selectedIndex == 3 ? Theme.of(context).primaryColor : Colors.white10),
              ),
              label: 'search'),
        ],
      ),
