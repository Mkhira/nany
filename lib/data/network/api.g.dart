...
class _AppServiceClient implements AppServiceClient {
  ...
  @override
  Future<LoginResponseModel> registerParent(registerModel) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<LoginResponseModel> registerSitter(registerModel) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<NannyDetails> getNannyDetails(
    token,
    id,
  ) async {
    const _extra = <String, dynamic>{};
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<NannyDetails>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = NannyDetails.fromJson(_result.data!);
    return value;
  }

  @override
  Future<Appointments> getAppointments(token) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  Future<Bookings> getBooking(
    ...
    final Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<Bookings>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = Bookings.fromJson(_result.data!);
    return value;
  }

  @override
  Future<dynamic> addAppointmentNanny(
    token,
    appointment,
  ) async {
    const _extra = <String, dynamic>{};
  ...
  Future<dynamic> confirmBook(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(bookPostModel.toJson());
    final _result = await _dio.fetch(_setStreamType<dynamic>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  @override
  Future<SuccessModel> changeStatusBooking(
    token,
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(bookingChangeStatusPostModel.toJson());
    final _result = await _dio
